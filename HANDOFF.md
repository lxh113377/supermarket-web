...
- 线上：sm_products=49、sm_reviews=20；SW 版本 sm-v1786129950705
- 坑：public-api 单独部署包需含 node_modules；`tcb fn log` CLI 3.6.4 不可用
...
- AdminGuard 删本地哈希兜底；PRODUCT_FIELDS 白名单；订单金额服务端重算
