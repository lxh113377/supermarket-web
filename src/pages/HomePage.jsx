...
export default function HomePage() {
  ...
  return (
    <div className="page-container">
      {/* Header - 更精致的渐变 + 呼吸感 */}
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-500 to-purple-600 text-white px-6 pt-12 pb-16">
        {/* 装饰性背景圆 */}
        <div className="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-white/10" />
        <div className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full bg-white/5" />
        <div className="relative z-10 text-center">
          <h1 className="text-2xl font-bold tracking-wide animate-fade-in-up">江科校园服务</h1>
      ...
      {/* 四大分类 - 交错入场 + 悬浮交互 */}
      <div className={`px-5 grid grid-cols-2 gap-4 max-w-lg mx-auto ${open ? '-mt-8' : 'mt-5'}`}>
        {CATEGORIES.map((cat, i) => (
          ...
          >
            <span className="text-4xl drop-shadow-sm transition-transform duration-300 group-hover:scale-110">{cat.icon}</span>
